...
<head>
    ...
    <title>CLASSIC MEN'S SALON || Appointments Form</title>
    <!-- Bootstrap -->
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <div class="footer-widget">
                            ...
                            <ul class="listnone contact">
                                <li><i class="fa fa-map-marker"></i> 495 East Street Camp Pune, MH 411001 </li>
                                <li><i class="fa fa-phone"></i> +91 123-980-4567</li>
                                <li><i class="fa fa-fax"></i> +91 123-4567890</li>
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="copyright-content">
                                <p>© CLASSIC MEN'S SALON @2022 | all rights reserved</p>
                            </div>
                        </div>
                    </div>
                </div>
